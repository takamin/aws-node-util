...
DynamoDbSqlishParser.LexBinder = new BNF("words", {
    "words": [
        [ "word", "words", ],
        [ "word", ],
    ],
...
DynamoDbSqlishParser.parseCreateTable = function(source) {
    var result = DynamoDbSqlishParser.bnfCreateTable.parse(source);
    return result;
};
DynamoDbSqlishParser.parseDeleteTable = function(source) {
    var result = DynamoDbSqlishParser.bnfDeleteTable.parse(source);
    return result;
};
DynamoDbSqlishParser.parseUpdateTable = function(source) {
    var result = DynamoDbSqlishParser.bnfUpdateTable.parse(source,
            DynamoDbSqlishParser.LexBinder);
    return result;
};
...
DynamoDbSqlishParser.parsePutItem = function(source) {
    var result = DynamoDbSqlishParser.bnfPutItem.parse(source,
            DynamoDbSqlishParser.LexBinder);
    return result;
};
DynamoDbSqlishParser.parseSetItem = function(source) {
    var result = DynamoDbSqlishParser.bnfSetItem.parse(source,
            DynamoDbSqlishParser.LexBinder);
    return result;
};
DynamoDbSqlishParser.parseDeleteItem = function(source) {
    var result = DynamoDbSqlishParser.bnfDeleteItem.parse(source,
            DynamoDbSqlishParser.LexBinder);
    return result;
};
