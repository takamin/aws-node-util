...
//
var EcmaScriptBnfElement = function() {};
var Literal = function() {};
Literal.prototype = new EcmaScriptBnfElement();
var DecimalLiteral = function() { };
DecimalLiteral.prototype = new EcmaScriptBnfElement();
module.exports.parseWord = function(lextoks) {
    var tokenList = [];
    var i = 0;
    var DFL = 0;
    var STRS = 1;
    ...
    var NUM = 3;
    var mode = DFL;
    while(i < lextoks.length) {
        var lextok = lextoks[i++];
        if(mode == DFL) {
        } else if(mode == STRS) {
        } else if(mode == STRD) {
        } else if(mode == NUM) {
