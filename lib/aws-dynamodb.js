(function() {
    ...
    //
    awscli.dynamodb.printScanResult = function(data) {
        var colNames = dynamodb.getAllScannedAttributeNames(data.Items);
        var rows = awscli.dynamodb.convertItemsTo2dArray(data.Items, colNames);
    ...
    //
    awscli.dynamodb.convertItemsTo2dArray = function(items, colNames) {
        var rows = [];
