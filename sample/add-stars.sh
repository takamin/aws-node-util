aws-dynamodb-put-item stars \
    "mainStar = 'SUN', role='planet', orbitOrder=1, name='MERCURY', mass=0.33, diameter=4879, density=5427, gravity=3.7, escapeVelocity=4.3, rotation=1407.6" \
    ...
    "mainStar = 'SUN', role='planet', orbitOrder=7, name='URANUS', mass=86.8, diameter=51118, density=1271, gravity=8.7, escapeVelocity=21.3, rotation=-17.2" \
    "mainStar = 'SUN', role='planet', orbitOrder=8, name='NEPTUNE', mass=102, diameter=49528, density=1638, gravity=11.0, escapeVelocity=23.5, rotation=16.1" \
    "mainStar = 'SUN', role='planet', orbitOrder=9, name='PLUTO', mass=0.0146, diameter=2370, density=2095, gravity=0.7, escapeVelocity=1.3, rotation=-153.3"
